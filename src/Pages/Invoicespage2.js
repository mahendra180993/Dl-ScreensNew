    ...
    return (
        <div>
            ...
            <div style={{width:200,height:250}} class="border-2 bg-white float-left text-gray-500 border-gray-300 rounded-xl drop-shadow-2xl ml-20 relative bottom-10">
                ...
                <img src="./assets/images/pad.png" class="mt-32 relative right-4"></img>
            ...
            <div style={{width:700,height:450}} class="border-2 bg-white float-left border-gray-300 rounded-xl drop-shadow-2xl ml-32 relative bottom-10">
                <img src="./assets/images/ama1.png" class="w-36 ml-20 mt-10"></img>
                <p class="ml-64 relative bottom-16 text-gray-800">AWS</p>
                <hr class="border-2 border-blue-500 rounded-xl ml-64 relative bottom-12" style={{width:400}}></hr>
                ...
                <p class="ml-96 relative left-32 mt-2 bottom-16 text-sm text-gray-500"><u>VERIFY CERTIFICATE</u></p>
                <hr style={{width:580}} class="ml-20 relative bottom-10"></hr>
                <div class="relative bottom-16">
                <img src="./assets/images/py.png" class="w-36 ml-20 mt-10"></img>
                <p class="ml-64 relative bottom-16 text-gray-800">Python</p>
                <hr class="border-2 border-gray-500 rounded-xl ml-64 relative bottom-12" style={{width:400}}></hr>
                <hr class="border-2 border-blue-500 rounded-xl ml-64 relative bottom-12" style={{width:160,position:"relative",bottom:52}}></hr>
